...
const { comparePassord } = require("../lib/passwordHash");
...
const login = async (email, password) => {
  ...
  if (!user || !(await comparePassord(password, user.password))) {
    throw new ApiError(httpStatus.UNAUTHORIZED, "Incorrect email or password");
  } else if (user.blocked) {
    throw new ApiError(
      httpStatus.UNAUTHORIZED,
      "Your account has been blocked! Please contact your adminstrator"
    );
  }
